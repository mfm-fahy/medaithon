...
router.get('/', authMiddleware, roleMiddleware(['admin', 'doctor', 'pharmacist']), async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
// Delete prescription
router.delete('/:id', authMiddleware, roleMiddleware(['doctor', 'admin']), async (req: AuthRequest, res: Response): Promise<void> => {
  try {
