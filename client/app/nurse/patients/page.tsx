...
export default function NursePatients() {
  ...
  const handleQRScan = async (patientId: string) => {
    console.log("🔵 Scanning patient:", patientId)
    setError("")
    setSuccess("")
    try {
  ...
  const handleUpdatePatient = async (updates: any) => {
    ...
    try {
      const token = localStorage.getItem("auth_token")
      console.log("🔵 Updating patient:", selectedPatient.patientId)
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Scan QR code or select patient to view and update vitals</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {loadingPatients ? (
                  ...
                  <div className="space-y-2 max-h-96 overflow-y-auto">
                    {patients.map((patient) => (
                      ...
                      >
                        <div className="font-medium text-sm">{patient.userId?.name || "Unknown"}</div>
          ...
          <div className="lg:col-span-2">
            {selectedPatient ? (
              <NursePatientDetailsCard patient={selectedPatient} onUpdate={handleUpdatePatient} />
            ) : (
              <Card>
...
function NursePatientDetailsCard({ patient, onUpdate }: { patient: Patient; onUpdate: (updates: any) => void }) {
