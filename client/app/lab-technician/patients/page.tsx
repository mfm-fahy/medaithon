...
export default function LabTechnicianPatients() {
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Scan QR code or select patient to view and add lab notes</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            {selectedPatient ? (
              <LabTechnicianPatientDetailsCard patient={selectedPatient} onUpdate={handleUpdatePatient} />
            ) : (
              <Card>
...
function LabTechnicianPatientDetailsCard({ patient, onUpdate }: { patient: Patient; onUpdate: (updates: any) => void }) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>View patient information and add lab notes</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        {patient.allergies && patient.allergies.length > 0 && (
          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm font-medium text-yellow-900">Allergies</p>
            <p className="text-sm text-yellow-800">{patient.allergies.join(", ")}</p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 border-t pt-4">
          <div>
            <label className="block text-sm font-medium mb-2">Lab Notes</label>
            <textarea
              value={notes}
              ...
              placeholder="Add lab test results and observations..."
              disabled={updating}
            />
          </div>
          ...
          >
            {updating ? "Adding Notes..." : "Add Lab Notes"}
          </Button>
        </form>
      </CardContent>
    </Card>
