        ...
        <Card className="backdrop-blur-xl bg-white/95 shadow-2xl border-2 border-white/60 hover:shadow-blue-400/30 transition-all duration-700 hover:scale-[1.02] animate-in fade-in slide-in-from-bottom-8 duration-1000 relative overflow-hidden group">
          ...
          <CardHeader className="space-y-1 pb-6 border-b border-gradient-to-r from-blue-200/50 via-teal-200/50 to-green-200/50 relative z-10">
            ...
            <CardDescription className="text-base text-gray-600 animate-in fade-in delay-200 duration-1000">
              Create a new doctor account for the hospital system
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 relative z-10">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Animated Input: Specialization */}
              <div className="group animate-in fade-in slide-in-from-left-6 duration-1000 delay-700 relative">
                <label className="block text-sm font-semibold mb-2 text-gray-700 group-hover:text-purple-600 transition-all duration-300 transform group-hover:translate-x-1">
                  <span className="inline-block">Specialization</span>
                </label>
                <div className="relative">
                  <Input
                    type="text"
              ...
              {/* Animated Buttons */}
              <div className="flex gap-4 pt-4 animate-in fade-in zoom-in duration-1000 delay-800">
                <Button 
                  type="submit" 
                  className="flex-1 relative bg-gradient-to-r from-green-500 via-teal-500 to-green-600 hover:from-green-600 hover:via-teal-600 hover:to-green-700 text-white font-bold shadow-xl hover:shadow-2xl hover:shadow-green-400/60 transition-all duration-500 hover:scale-110 active:scale-95 border-2 border-green-300/50 hover:border-green-200 overflow-hidden group"
                >
